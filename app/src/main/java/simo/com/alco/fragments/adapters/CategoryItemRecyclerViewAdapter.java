...
public class CategoryItemRecyclerViewAdapter extends RecyclerView.Adapter<CategoryItemRecyclerViewAdapter.ViewHolder> {
    ...
    private final List<ApiCategory> mValues;
    private final OnListFragmentItemSelection mListener;

    public CategoryItemRecyclerViewAdapter(List<ApiCategory> items, OnListFragmentItemSelection listener) {
        mValues = items;
        mListener = listener;
    }
